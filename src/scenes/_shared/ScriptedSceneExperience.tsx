...
function Environment({ kind }: { kind: EnvironmentKind }) {
  ...
  if (kind === 'dorm-loft') return <group><RoomShell windowSide="left" /><Model src={ASSETS.bunkBed} position={[0.08, 0.02, 0.02]} rotation={[0, Math.PI / 2, 0]} scale={3.3} opacity={0.62} lineOpacity={0.48} edge={WHITE_EDGE} /></group>
