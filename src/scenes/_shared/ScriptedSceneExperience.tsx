...
export type EnvironmentKind = 'kitchen' | 'living' | 'study' | 'balcony' | 'city-link' | 'choice-room' | 'meeting-room' | 'home-study' | 'dorm-loft' | 'cozy-study'
...
function Environment({ kind }: { kind: EnvironmentKind }) {
  ...
  if (kind === 'dorm-loft') return <group><RoomShell windowSide="left" /><LineBox position={[0, 1.78, 0.02]} scale={[2.42, 0.04, 1.06]} color="#121a24" edge={WHITE_EDGE} opacity={0.28} /><LineBox position={[-1.12, 0.9, 0.02]} scale={[0.08, 1.72, 0.08]} color="#121a24" edge={SOFT_EDGE} opacity={0.32} /><LineBox position={[1.12, 0.9, 0.02]} scale={[0.08, 1.72, 0.08]} color="#121a24" edge={SOFT_EDGE} opacity={0.32} /><LineBox position={[-1.12, 0.9, -0.48]} scale={[0.08, 1.72, 0.08]} color="#121a24" edge={SOFT_EDGE} opacity={0.32} /><LineBox position={[1.12, 0.9, -0.48]} scale={[0.08, 1.72, 0.08]} color="#121a24" edge={SOFT_EDGE} opacity={0.32} /><Model src={ASSETS.bedTwin} position={[0, 1.86, -0.22]} rotation={[0, Math.PI / 2, 0]} scale={1.55} opacity={0.42} lineOpacity={0.32} edge={WHITE_EDGE} /><Model src={ASSETS.desk} position={[0.08, 0.44, 0.1]} scale={1.34} opacity={0.46} lineOpacity={0.34} edge={WHITE_EDGE} /><Model src={ASSETS.chair} position={[-0.12, 0.18, 0.72]} rotation={[0, Math.PI, 0]} scale={0.82} opacity={0.46} lineOpacity={0.34} /><Model src={ASSETS.computer} position={[0.18, 0.94, -0.28]} scale={0.5} opacity={0.46} lineOpacity={0.32} edge={ACTIVE_BLUE} /><Model src={ASSETS.keyboard} position={[0.0, 0.86, 0.02]} scale={0.34} opacity={0.4} lineOpacity={0.26} /><Model src={ASSETS.bookcase} position={[2.0, 0, -1.06]} scale={1.0} opacity={0.28} lineOpacity={0.22} edge={SOFT_EDGE} /><LineBox position={[-1.26, 0.88, 0.34]} scale={[0.04, 1.54, 0.04]} color="#121a24" edge={WHITE_EDGE} opacity={0.36} />{[-0.36, 0.02, 0.4, 0.78].map((y) => <LineBox key={y} position={[-1.24, y + 0.66, 0.34]} scale={[0.04, 0.03, 0.42]} color="#121a24" edge={WHITE_EDGE} opacity={0.28} rotation={[0, 0, Math.PI / 2]} />)}<Model src={ASSETS.curtain} position={[-3.44, 0.36, -0.36]} rotation={[0, Math.PI / 2, 0]} scale={1.18} opacity={0.28} lineOpacity={0.22} edge={SOFT_EDGE} /><Model src={ASSETS.curtain} position={[-3.44, 0.36, 0.3]} rotation={[0, Math.PI / 2, 0]} scale={1.18} opacity={0.28} lineOpacity={0.22} edge={SOFT_EDGE} /></group>
