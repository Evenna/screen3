...
function Environment({ kind }: { kind: EnvironmentKind }) {
  ...
  if (kind === 'dorm-loft') return <group><RoomShell windowSide="left" /><Model src={ASSETS.bunkBed} position={[-0.42, 0.06, -0.12]} rotation={[0, Math.PI / 2, 0]} scale={1.62} opacity={0.5} lineOpacity={0.38} edge={WHITE_EDGE} /><Model src={ASSETS.desk} position={[0.96, 0.44, 0.24]} scale={1.24} opacity={0.46} lineOpacity={0.34} edge={WHITE_EDGE} /><Model src={ASSETS.chair} position={[0.78, 0.16, 0.9]} rotation={[0, Math.PI, 0]} scale={0.8} opacity={0.46} lineOpacity={0.34} /><Model src={ASSETS.computer} position={[1.08, 0.94, -0.12]} scale={0.48} opacity={0.46} lineOpacity={0.32} edge={ACTIVE_BLUE} /><Model src={ASSETS.keyboard} position={[0.9, 0.86, 0.14]} scale={0.34} opacity={0.4} lineOpacity={0.26} /><Model src={ASSETS.bookcase} position={[2.22, 0, -1.06]} scale={0.94} opacity={0.28} lineOpacity={0.22} edge={SOFT_EDGE} /><Model src={ASSETS.curtain} position={[-3.44, 0.36, -0.36]} rotation={[0, Math.PI / 2, 0]} scale={1.18} opacity={0.28} lineOpacity={0.22} edge={SOFT_EDGE} /><Model src={ASSETS.curtain} position={[-3.44, 0.36, 0.3]} rotation={[0, Math.PI / 2, 0]} scale={1.18} opacity={0.28} lineOpacity={0.22} edge={SOFT_EDGE} /></group>
