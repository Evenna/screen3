...
const config: ScriptedSceneConfig = {
  ...
  panels: [
    { id: 'agenda', title: '会议室屏幕', subtitle: '90 秒开场', position: [0.08, 1.9, 0.28], start: 5.8, end: 38.5, variant: 'main', lines: ['结论：Q3 先修留存，不先加投放', '证据 1：30 天留存 48% → 41%', '证据 2：第 3 天流失最集中', '动作：onboarding / 召回 / 小组试点'] },
  ...
  routes: [
    { to: [0.08, 1.9, 0.28], start: 5.0, end: 6.5, holdUntil: 38.5, color: MAIN_BLUE, width: 0.006 },
  ...
  camera: [
    { at: 0, position: new THREE.Vector3(2.45, 2.05, 3.05), look: new THREE.Vector3(0.02, 1.18, 0.2), zoom: 128 },
    { at: 7, position: new THREE.Vector3(1.85, 1.76, 2.22), look: new THREE.Vector3(0.04, 1.35, 0.34), zoom: 154 },
    { at: 18, position: new THREE.Vector3(2.55, 2.28, 2.86), look: new THREE.Vector3(0.08, 1.5, 0.18), zoom: 130 },
    { at: 41.8, position: new THREE.Vector3(2.2, 1.9, 2.62), look: new THREE.Vector3(0.02, 1.12, 0.3), zoom: 142 },
  ],
}
